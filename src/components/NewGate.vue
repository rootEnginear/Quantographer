<template>
  ...
  <section v-if="build_method === 0">
    <div class="row">
      <div class="col">
        <div class="field">
          <label class="label">Theta (rad)</label>
          <div class="control">
            <input v-model="rot_theta" class="input" type="text" placeholder="0" />
          </div>
        </div>
      </div>
      <div class="col">
        <div class="field">
          <label class="label">Phi (rad)</label>
          <div class="control">
            <input v-model="rot_phi" class="input" type="text" placeholder="-pi/4" />
          </div>
        </div>
      </div>
      <div class="col">
        <div class="field">
          <label class="label">Global Phase (rad)</label>
          <div class="control">
            <input v-model="rot_lambda" class="input" type="text" placeholder="pi/4" />
          </div>
        </div>
      </div>
    </div>
  ...
  <section v-if="build_method === 1">
    <div class="field">
      ...
      <div class="control">
        <input v-model="mat_qubits" class="input" type="number" placeholder="0" min="1" max="4" />
      </div>
    </div>
    <div class="matrix-viz" :style="{ gridTemplateColumns: `repeat(${2 ** +mat_qubits},1fr)` }">
      <input
  ...
  <section v-if="build_method === 2">
    <p>You can create a custom gate from a part of the circuit by grouping them, then right click on the group and select "Convert to Custom Gate".</p>
  </section>
  <div class="space"></div>
